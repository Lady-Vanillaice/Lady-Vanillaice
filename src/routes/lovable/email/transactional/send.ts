...
const SITE_NAME = "Lady Vanilla_ice"
  ...
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        // Require admin role — this endpoint must not be callable by ordinary
        // signed-in users, otherwise anyone who registers can send branded
        // emails from the verified sender to arbitrary recipients.
