  ...
  .handler(async ({ context }) => {
    ...
    const bookings: CashBookEntry[] = (bookingRes.data ?? []).map((b: any) => {
      ...
      const common = {
        ...
        deposit_exemption_reason: exemptionFromNote, deposit_guarantor: b.deposit_guarantor ?? null,
